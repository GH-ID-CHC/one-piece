...
<html>
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-dark bg-dark py-4">
      <div class="container">
        <a class="navbar-bran" href="./"><img src="assets/images/logo/logo.png"></a>
...
<!--            pages-->
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbar_main_dropdown_1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">素材区域</a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="./docs/introduction.html">讨论区</a>
            </li>
            <li class="nav-item">
    ...
    <main class="main">
      ...
      <section class="spotlight parallax bg-cover bg-size--cover container">
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/images/backgrounds/img_4.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/images/backgrounds/img_3.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/images/backgrounds/img_5.png" class="d-block w-100" alt="...">
            </div>
          </div>
        </div>
      </section>
